...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_5x6_5(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_GRV,
                                   KC_NO,   KC_NO,   KC_NO,   KC_NO,   LT(1,KC_SPC),    KC_LGUI,  KC_NO,   KC_NO,   KC_NO,   KC_NO,
                                   KC_TAB,  KC_LALT, LT(2,KC_ENT),   KC_BSPC
    ),
    /*
     * symbol
     *
    ...
    [1] = LAYOUT_5x6_5(
        ...
        KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_PERC,                KC_CIRC, KC_DLR,  KC_LCBR, KC_RCBR, KC_AMPR, KC_NO,
                                 KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_TRNS,    KC_ASTR,  KC_NO,   KC_NO,   KC_NO,   KC_NO,
                                 QK_BOOT, KC_TRNS, KC_AT,   KC_HASH
    ),
    /*
     * 0-9 / F1-F12 / func
     *
