...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_5x6_5(
        ...
        KC_NO,   KC_EXLM,    KC_AT,      KC_CIRC,    KC_DLR,     KC_PERC, /* */ KC_MINS, LSFT(KC_P), KC_LPRN, KC_RPRN, KC_DQUO, KC_PIPE,
        KC_LGUI, KC_NO,      KC_NO,      KC_AMPR,    KC_HASH,    KC_ASTR, /* */ KC_LT,   KC_GT,      KC_LCBR, KC_RCBR, KC_QUES, KC_NO,
