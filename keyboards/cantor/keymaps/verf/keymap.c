...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        LCTL_T(CW_TOGG), KC_A, KC_S, KC_E,    KC_T,         KC_G,    /* */ KC_Y,  KC_N,         KC_I,    KC_O,   KC_H,    KC_QUOT,
        KC_LSFT,         KC_Z, KC_X, KC_C,    KC_V,         KC_B,    /* */ KC_P,  KC_M,         KC_COMM, KC_DOT, KC_SLSH, KC_GRV,
                                     KC_LALT, LT(1,KC_SPC), KC_LGUI, /* */ MO(3), LT(2,KC_ENT), KC_BSPC
    ),
    /*
     * SYM
     */
    [1] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_NO,      KC_NO,      KC_NO,      KC_HASH,    KC_ASTR, /* */ KC_LT,   KC_GT,   KC_LCBR, KC_RCBR, KC_QUES, KC_TILD,
                                         KC_NO,      KC_TRNS,    QK_BOOT, /* */ KC_NO,   KC_ENT,  KC_TRNS
    ),
    /*
     * NUM
     */
    [2] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_NO, KC_NO, KC_NO,   KC_NO,  KC_NO,   /* */ KC_NO, KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,
                               KC_TRNS, KC_SPC, KC_TRNS, /* */ KC_NO, KC_TRNS, KC_NO
    ),
    /*
     * NAV / FUNC
     */
    [3] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   /* */ KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO, KC_NO,
                                 KC_TRNS, KC_NO,   KC_TRNS, /* */ KC_TRNS, KC_NO,   LCA(KC_DEL)
    ),
};
