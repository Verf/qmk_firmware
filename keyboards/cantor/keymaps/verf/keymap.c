...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C,    KC_V,         KC_B,   /* */  KC_P,    KC_M,         KC_COMM, KC_DOT, KC_SLSH, KC_GRV,
                             KC_TAB,  LT(1,KC_SPC), KC_LGUI, /* */ KC_LSFT, LT(2,KC_ENT), KC_BSPC
    ),
    /*
     * SYM
     */
    ...
    [3] = LAYOUT_split_3x6_3(
        ...
        TG(4),   TG(5), KC_NO, KC_NO,   KC_NO,   KC_EQL,  /* */ KC_MINS, KC_PLUS, KC_COMM, KC_DOT,  KC_SLSH, TG(0),
    ...
    [4] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C,   KC_V,   KC_B,    /* */ KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, TG(0),
                             KC_TAB, KC_SPC, KC_LALT, /* */ KC_LSFT, KC_ENT, KC_BSPC
    ),
    /*
     * BASE (Gallium)
     */
    [5] = LAYOUT_split_3x6_3(
        KC_ESC,  KC_B, KC_L, KC_D,    KC_C,         KC_V,   /* */  KC_J,    KC_Y,         KC_O,    KC_U,    KC_COMM, KC_BSLS,
        CW_TOGG, KC_N, KC_R, KC_T,    KC_S,         KC_G,   /* */  KC_P,    KC_H,         KC_A,    KC_E,    KC_I,    KC_SLSH,
        KC_LSFT, KC_X, KC_Q, KC_M,    KC_W,         KC_Z,   /* */  KC_K,    KC_F,         KC_QUOT, KC_SCLN, KC_DOT,  KC_GRV,
                             KC_TAB,  LT(1,KC_SPC), KC_LGUI, /* */ KC_LSFT, LT(2,KC_ENT), KC_BSPC
    ),
};
